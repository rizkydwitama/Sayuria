          ...
          <form method="post" id="sample_form" class="form-horizontal">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="nama_sayur" id="nama_sayur" class="form-control" />
                  </div>
                  <div class="form-group">
                    <label>Harga Sayur : </label>
                    <input type="text" name="harga_sayur" id="harga_Sayur" class="form-control" />
                </div>
                <div class="form-group">
...
<script type="text/javascript">
 $(document).ready(function() {
    var table = $('.user_datatable').DataTable({
        ...
        columns: [
            {data: 'id', name: 'id'},
            {data: 'nama_sayur', name: 'name'},
            {data: 'harga_sayur', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' ),name: 'Harga'},
    ...
    $(document).on('click', '.edit', function(event){
        ...
        $.ajax({
            ...
            {
                console.log('success: '+data);
                $('#nama_sayur').val(data.result.nama_sayur);
                $('#harga_sayur').val(data.result.harga_sayur);
